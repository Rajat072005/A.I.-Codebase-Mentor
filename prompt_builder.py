...
PROMPT_TEMPLATES = {
    ...
    "architecture" : {
        ...
        ## Architectural Notes
        Mention important architectural patterns, design decisions, or observations that are evident from the retrieved context.
        """
    },
    "implementation" : {
        ...
        ## Developer Notes
        Mention any important observations, assumptions, limitations, or extension points visible in the retrieved context.
        """
    },
    "debug" : {
        ...
        "objective" : "Analyze the retrieved repository context to identify the most likely cause of the reported issue, explain the reasoning behind the diagnosis, and recommend practical debugging steps or fixes without making unsupported assumptions.",
        ...
        - If the retrieved context is insufficient, explicitly mention what additional files or information should be inspected.
        ...
        Mention any missing information or repository areas that should be inspected if the current context is insufficient.
        """
    },
    "locate" : {
        ...
        -If the retrieved context is insufficient to confidently locate the requested functionality, clearly state that the relevant location could not be identified from the available context.
        """,
        "answer_format" : """
        - Focus on identifying the most relevant files, folders, functions, or components.
        - Mention repository paths whenever they are available.
    ...
    "comparison" : {
        ...
        "objective" : "Compare the requested modules, components, or implementations by highlighting their responsibilities, similarities, differences, design decisions, and trade-offs using only the retrieved repository context.",
        ...
        ## Trade-offs
        Discuss the advantages or disadvantages of each approach if supported by the retrieved context.
    ...
    "casual" : {
        ...
        - If the question is unrelated to programming, answer it naturally as a helpful assistant.
        """,
        "answer_format" : """
        ...
        Include examples whenever they help explain the concept.
        """
    },
}
